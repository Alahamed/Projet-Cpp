...
QSqlQueryModel * equipe::afficher_id()
{
    QSqlQueryModel* model=new QSqlQueryModel();
    model->setQuery("SELECT id FROM equipe1");
    model->setHeaderData(0, Qt::Horizontal,QObject::tr("ID"));
    return model;
}
...
QSqlQueryModel * equipe::recherche_capitain(QString capitain){
    QSqlQueryModel * model = new QSqlQueryModel();
    model->setQuery("Select * From equipe1 WHERE JOUEUR1 ='" +capitain+"'");
    model->setHeaderData(0, Qt::Horizontal,QObject::tr("ID"));
    model->setHeaderData(1, Qt::Horizontal,QObject::tr("NOM"));
    model->setHeaderData(2, Qt::Horizontal,QObject::tr("JOUEUR1"));
    model->setHeaderData(3, Qt::Horizontal,QObject::tr("JOUEUR2"));
...
QSqlQueryModel * equipe::trier_id2()
{
    QSqlQueryModel * model= new QSqlQueryModel();
    model->setQuery("Select * from equipe1 Order by id DESC");
    model->setHeaderData(0, Qt::Horizontal,QObject::tr("ID"));
    model->setHeaderData(1, Qt::Horizontal,QObject::tr("NOM"));
    model->setHeaderData(2, Qt::Horizontal,QObject::tr("JOUEUR1"));
    model->setHeaderData(3, Qt::Horizontal,QObject::tr("JOUEUR2"));
