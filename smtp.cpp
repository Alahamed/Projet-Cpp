...
void Smtp::sendMail(const QString &from, QString to, const QString &subject,int x)
{
    ...
    message.append("Subject: " "NOUVEL EMPLACEMENT" "\n");
    ...
    message.append("<html><head></head><body><center>"+QString("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=""10"" color =""Green"">Bonjour, vous trouverez ci-dessous la liste de tous les emplacements disponibles </font><br /> <br /> "));





  message.append("<center>"+QString("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=""4"" color =""Black""></font><br /></html>"));
